    ...
    <div class="container"> <a class="navbar-brand" href="#">
      ...
      <div class="collapse navbar-collapse" id="navbar16">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item"> <a class="nav-link" href="#">產品介紹</a> </li>
          <li class="nav-item active"> <a class="nav-link" href="#">門市地點</a> </li>
        </ul>
      </div>
    </div>
  </nav>
      ...
      <div class="row">
        <div class="col-md-12">
          <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="#">產品介紹</a></li>
            <li class="breadcrumb-item active">無糖巧克力草莓塔</li>
          </ul>
        </div>
      </div>
      <div class="row">
        <div class="p-0 order-2 order-lg-1 col-lg-5"> <img class="img-fluid d-block" src="imgs/product/details/product-big-4.jpg"> </div>
        <div class="d-flex flex-column justify-content-center p-3 order-1 order-lg-2 col-lg-7">
          <h3 class="">無糖巧克力草莓塔</h3>
          <p class="lead mb-0">情人節甜點提案！無糖、無麩質、生酮也可以吃的無糖巧克力草莓塔，超好吃而且適合新手操作。內餡跟松露巧克力一樣是霜霜、入口即化口感，放上心型草莓，表達你的甜蜜之外，酸甜的草莓跟巧克力是絕配。</p>
        </div>
      </div>
    </div>
  </div>
